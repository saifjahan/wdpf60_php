                ...
                <a href="" class="media-list-link read">
                  <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <p>I should be incapable of drawing a  Katherine P. Lumaadle stroke at the present moment...</p>
                    </div>
                  </div><!-- media -->
                </a>
                <a href="" class="media-list-link read">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              ...
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="loge_out.php"><i class="icon ion-power"></i> Sign Out</a></li>
              </ul>
            </div><!-- dropdown-menu -->
          </div><!-- dropdown -->
        </nav>
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 settings-scrollbar" id="settings" role="tabpanel">
          ...
          <div class="sidebar-settings-item">
            ...
            <p class="op-5 tx-13">Sign in u Katherine P. Lumaad a two step verification by sending a verification code to your phone.</p>
