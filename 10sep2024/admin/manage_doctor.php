                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">doctorspecilization</h4>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="" class="btn btn-outline-primary waves-effect waves-light">edit</a> | <a href="" class="btn btn-outline-dark waves-effect waves-light">delete</a></td>
                                            </tr>
                                            <?php
                                            $sn++;
                                            }
