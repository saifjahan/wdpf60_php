...
--
-- Host: 127.0.0.1:3310
-- Generation Time: Aug 27, 2024 at 01:03 PM
...
(5000, 'chowdhury', 'Ahmed', '302', 'masum@gmail.com', '6', 1001, 'Assistant programmer');
...
(4, ' sony refegeretor 19\'\'c', 'delete', '2024-08-25 07:00:44'),
(5, 'singer tv 30\'\' ', 'delete', '2024-08-25 07:14:33'),
(6, 'sony', 'delete', '2024-08-25 07:14:33');
...
('root', '[{\"db\":\"wdpf60_transation\",\"table\":\"trunks\"},{\"db\":\"wdpf60_transation\",\"table\":\"participants\"},{\"db\":\"classicmodels\",\"table\":\"products\"},{\"db\":\"evidence\",\"table\":\"product\"},{\"db\":\"evidence\",\"table\":\"manufacturer\"},{\"db\":\"evidence\",\"table\":\"product_above_5000_price\"},{\"db\":\"evidence\",\"table\":\"log_book\"},{\"db\":\"evidence\",\"table\":\"manufacturer_bk\"},{\"db\":\"evidence\",\"table\":\"product_list\"},{\"db\":\"evidence\",\"table\":\"products_above_10000_price\"}]');
...
('root', 'classicmodels', 'products', '{\"sorted_col\":\"`products`.`productCode` DESC\"}', '2024-08-27 05:55:29'),
('root', 'evidence', 'product', '{\"sorted_col\":\"`product`.`id` ASC\"}', '2024-08-24 05:04:29');
...
('root', '2024-08-27 04:27:04', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `wdbf60`
--
CREATE DATABASE IF NOT EXISTS `wdbf60` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `wdbf60`;
--
-- Database: `wdpf60`
--
...
(1, 'saif@gmail.com', '123abc', 'saifhajahan');
...
--
-- Database: `wdpf60_transation`
--
CREATE DATABASE IF NOT EXISTS `wdpf60_transation` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `wdpf60_transation`;
...
-- Database: `wepf601`
--
CREATE DATABASE IF NOT EXISTS `wepf601` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `wepf601`;
